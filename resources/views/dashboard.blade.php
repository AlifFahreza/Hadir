          ...
          <div class="col-lg-8">
            <div class="row">
              ...
              <div class="card mb-3">
                <div class="row g-0">
                  <div class="col-md-4">
                    <img src="{{('assets/img/gambar presensi.png')}}" style=" width: 50%; padding-top: 5%;padding-bottom: 5%;" class="img-fluid rounded-start" alt="...">
                  </div>
                  <div class="col-md-8">
                    <div class="card-body ">
                        ...
                        <table class="table datatable">
                            ...
                            @foreach($dataPresensi as $presensi)
                                @foreach($presensi->sekretaris as $sekretaris)
                                    ...
                                    <td>{{ $sekretaris->jam_presensi }}</td>
                                    <td>{{ $presensi->event_name }}</td>
                                    <td>{{ $presensi->nama_organisasi }}</td>
          ...
          <div class="col-lg-4">
            ...
            <div class="card">
                ...
                <div class="card-body pb-0">
                    ...
                    <div class="d-flex justify-content-center" style="text-align:center;margin-bottom:30px; margin-top:-50px;margin-left:30px;"></div>

                    <img src="assets/img/absence.png" alt="Absence Image" style="display:block; margin:auto;max-width:300px; margin-top: 20%;">
                    <a    class="text-center" id="absensiButton" type="button" style="background-color:blue; height: 50%; width: 100%; margin-bottom: 5%; margin-top: 10%; color: white; font-size: 25px; font-weight: 900; ">
                        Presensi
                    </a>
                </div>
            </div>
                    ...
                    <div class="modal-body">
                        <form>
                            <div class="form-group">
                                ...
                                <input type="text" id="paslon" class="form-control" placeholder="Contoh form text ...">
                            </div>
                            <div class="form-group">
