                                ...
                                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                    ...
                                    <form method="post" action="{{ route('admin.update') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <input name="departemen" type="text" class="form-control" id="departemen" value="{{ $admin->departemen }}">
                                            </div>
                                        </div>

                                        <!-- Input untuk institusi -->
                                        <div class="row mb-3">
                                            <label for="institusi" class="col-md-4 col-lg-3 col-form-label">Institusi</label>
                                            <div class="col-md-8 col-lg-9">
                                                <input name="institusi" type="text" class="form-control" id="institusi" value="{{ $admin->institusi }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <input name="address" type="text" class="form-control" id="alamat" value="{{ $admin->address }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            <label for="more" class="col-md-4 col-lg-3 col-form-label">More</label>
                                            <div class="col-md-8 col-lg-9">
